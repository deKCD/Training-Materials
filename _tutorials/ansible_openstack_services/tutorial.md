...
questions:
  - How do Ansible roles and Docker Swarm enable modular, reproducible deployment of containerized services on OpenStack?
objectives:
  ...
  - Learn how to set up additional Docker swarm for container orchestration.
key_points:
