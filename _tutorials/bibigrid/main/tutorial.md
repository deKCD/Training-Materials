...
Use the prefilled configuration template [resources/bibigrid.yaml]({{ "/tutorials/bibigrid/resources/bibigrid.yaml" | relative_url }}) as a basis for your personal BiBiGrid configuration. 
...
![Navigation]({{ "/tutorials/bibigrid/images/ac_screen1.png" | relative_url }}){: .responsive-img }
...
![Creation]({{ "/tutorials/bibigrid/images/ac_screen2.png" | relative_url }}){: .responsive-img }
...
![Theia]({{ "/tutorials/bibigrid/images/theia.png" | relative_url }}){: .responsive-img }
