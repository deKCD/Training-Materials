#!/usr/bin/env python
# This script was taken from the GTN repository, and modified to fit the needs of this repository.
# This script checks the structure of learning boxes in a tutorial markdown file.
import copy
import re
import sys
import logging
